...
R11. [UI] **Responsive + full-width layout**: on large screens the dashboard (and other pages) renders in a narrow column with lots of empty space (see screenshot — big monitor, tiny centered content). Fix globally:
